...
const ProductAll = ({ products, getBasketCount, basketCount, isLogin, setProductData }) => {
    ...
    return (
        <div>
            ...
            <div className='flex text-left mx-12 text-gray-500'>
                <p>shwoing : {products.length} items</p>
            </div>
            <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  mx-10 gap-x-2 gap-y-2'>
